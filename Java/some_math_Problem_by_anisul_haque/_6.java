        ...
        for(int j=0;j<n;j++){
            ...
            if(val[0]>val[1]){
                if (val[0]>val[2]) {
                    if(val[0]>val[3]){
                        if (val[0]>val[4]) {
                            System.out.println("Maximum Number is : "+val[0]);
                        }
                        else{
                            System.out.println("Maximum Number is : "+val[4]);
                        }
                    }
                    else{
                        if(val[3]>val[4]){
                            System.out.println("Maxium Number is : "+val[3]);
                        }
                        else{
                            System.out.println("Maximum Number is : "+val[4]);
                        }
                    ...
                    if(val[2]>val[3]){
                        if(val[2]>val[4]){
                            System.out.println("Maximum Number is : "+val[2]);
                        }
                        else{
                            System.out.println("Maximum Number is : "+val[4]);
                        }
                        ...
                        if(val[3]>val[4]){
                            System.out.println("Maximum Number is : "+val[3]);
                        }
                        else{
                            System.out.println("Maximum Number is : "+val[4]);
                        }
                ...
                if (val[1]>val[2]) {
                    if(val[1]>val[3]){
                        if(val[1]>val[4]){
                            System.out.println("Maximum Number is : "+val[1]);
                        }
                        else{
                            System.out.println("Maximum Number is : "+val[4]);
                        }
